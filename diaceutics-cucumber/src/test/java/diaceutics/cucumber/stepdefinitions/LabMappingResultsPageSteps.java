...
import diaceutics.selenium.enums.pageFields.LabMappingResultsFormFields;
...
public class LabMappingResultsPageSteps {
    ...
    @And("Lab {string} is displayed on Lab Mapping Results page")
    ...
    @When("I click by {string} on Lab Mapping Results page")
    ...
    public void assayWithFollowingFieldsIsDisplayedOnLabMappingResultsPage(String key, List<String> fields) {
        ...
        fields.forEach(field -> {
            String expectedValue = field.equals("Biomarkers") ? expectedAssay.getBiomarkers().get(0).getBiomarker() :
                    expectedAssay.getReflectionFieldValue(LabMappingResultsFormFields.getEnumValue(field).getModelField());

            String actualValue = labMappingResultsPage.getLabMappingResultsGrid()
                    .getFieldValue(LabMappingResultsFormFields.getEnumValue(field));
